...
//		System.out.println("aioCheckOutWebATM: " + genAioCheckOutWebATM());
	...
	public static String genAioCheckOutALL() {
		...
		obj.setMerchantTradeNo("NSY" + today2 + treadeNo);
		obj.setMerchantTradeDate(today);
		obj.setTotalAmount("199");
		obj.setTradeDesc("會員開始日期= " + today);
		obj.setItemName("NSY專業版(單月)");
		obj.setReturnURL("http://211.23.128.214:5000");
		obj.setNeedExtraPaidInfo("N");
		String form = all.aioCheckOut(obj, null);
		return form;
	...
	public static String genAioCheckOutALL2() {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd hh:mm:ss");
		SimpleDateFormat sdf2 = new SimpleDateFormat("yyyyMMdd");
		String today = sdf.format(new Date());
		String today2 = sdf2.format(new Date());
		...
		obj.setMerchantTradeNo("NSY" + today2 + treadeNo);
		obj.setMerchantTradeDate(today);
		obj.setTotalAmount("2149");
		obj.setTradeDesc("會員開始日期= " + today);
		obj.setItemName("NSY年費會員");
		obj.setReturnURL("http://211.23.128.214:5000");
		obj.setNeedExtraPaidInfo("N");
		String form = all.aioCheckOut(obj, null);
		return form;
